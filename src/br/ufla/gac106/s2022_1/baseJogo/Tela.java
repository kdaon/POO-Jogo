...
public class Tela implements InterfaceUsuario
{
    ...
    private void criarPainelInferior() {
        ...
        criarSubPainelDirecoes(painelInferior);
    ...
    private void criarSubPainelDirecoes(JPanel painelPai) {
        // cria o painel de entrada do jogador e define seu tamanho
        JPanel painelEntrada = new JPanel();
        painelEntrada.setPreferredSize(new Dimension(larguraJanela,50));
        
        // cria um rótulo com o texto "Comando: " e o adiciona ao painel
        painelEntrada.add(new JLabel("Direções:"));
        ...
        // Cria um botão para enviar os comandos e o adiciona ao painel
        JButton botaoComandoNorte = new JButton("ir Norte");
        painelEntrada.add(botaoComandoNorte);
        JButton botaoComandoSul = new JButton("ir Sul");
        painelEntrada.add(botaoComandoSul);
        JButton botaoComandoLeste = new JButton("ir Leste");
        painelEntrada.add(botaoComandoLeste);
        JButton botaoComandoOeste = new JButton("ir Oeste");
        painelEntrada.add(botaoComandoOeste);
        JButton botaoComandoCima = new JButton("ir Cima");
        painelEntrada.add(botaoComandoCima);
        JButton botaoComandoBaixo = new JButton("ir Baixo");
        painelEntrada.add(botaoComandoBaixo);
        JButton botaoComandoPassado = new JButton("ir Passado");
        painelEntrada.add(botaoComandoPassado);
        JButton botaoComandoFuturo= new JButton("ir Futuro");
        painelEntrada.add(botaoComandoFuturo);
        ...
        // ou seja, define o código que é executado quando o usuário clica no botão 'Enviar"
        // ou quando aperta ENTER dentro da caixa de texto dos comandos.
        Action acaoEnviarDirecaonNorte = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoNorte.getText();
                //campoEntrada.setText("");
            }
        };
        
        Action acaoEnviarDirecaonSul = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoSul.getText();
                //campoEntrada.setText("");
            }
        };
        Action acaoEnviarDirecaonLeste = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoLeste.getText();
                //campoEntrada.setText("");
            }
        };
        Action acaoEnviarDirecaonOeste = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoOeste.getText();
                //campoEntrada.setText("");
            }
        };
        Action acaoEnviarDirecaonCima = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoCima.getText();
                //campoEntrada.setText("");
            }
        };
        Action acaoEnviarDirecaonBaixo = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoBaixo.getText();
                //campoEntrada.setText("");
            }
        };
        Action acaoEnviarDirecaonPassado = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoPassado.getText();
                //campoEntrada.setText("");
            }
        };
        Action acaoEnviarDirecaonFuturo = new AbstractAction()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                comandoEnviado = botaoComandoFuturo.getText();
                //campoEntrada.setText("");
            }
        };
        // liga a ação à caixa de texto de comandos
        //campoEntrada.addActionListener(acaoEnviarDirecao);
        // liga a ação ao clique no botão "Enviar"
        botaoComandoNorte.addActionListener(acaoEnviarDirecaonNorte);
        botaoComandoSul.addActionListener(acaoEnviarDirecaonSul);
        botaoComandoLeste.addActionListener(acaoEnviarDirecaonLeste);
        botaoComandoOeste.addActionListener(acaoEnviarDirecaonOeste);
        botaoComandoCima.addActionListener(acaoEnviarDirecaonCima);
        botaoComandoBaixo.addActionListener(acaoEnviarDirecaonBaixo);
        botaoComandoPassado.addActionListener(acaoEnviarDirecaonPassado);
        botaoComandoFuturo.addActionListener(acaoEnviarDirecaonFuturo);
